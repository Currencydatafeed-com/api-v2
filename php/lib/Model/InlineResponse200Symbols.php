...
/**
 * InlineResponse200Symbols Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse200Symbols implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_symbols';
     ...
     * Sets symbol
     *
     * @param string $symbol Symbol code (e.g. \"EURUSD\" or \"BTCUSDT\")
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Name/description of the symbol or pair
     *
     * @return $this
     */
     ...
     * Sets updated
     *
     * @param string $updated Last updated datetime or timestamp
     *
     * @return $this
     */
