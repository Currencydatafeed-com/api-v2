...
class InlineResponse2006Data implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'currency' => 'string',
        'type' => 'string',
        'history' => '\Swagger\Client\Model\InlineResponse2006History[]',
        'error' => 'string'
    ];
     ...
     * Sets currency
     *
     * @param string $currency Queried or reversed pair symbol
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type Data type (\"original\" or \"reversed\")
     *
     * @return $this
     */
     ...
     * Gets history
     *
     * @return \Swagger\Client\Model\InlineResponse2006History[]
     */
     ...
     * Sets history
     *
     * @param \Swagger\Client\Model\InlineResponse2006History[] $history Array of OHLC objects for the range
     *
     * @return $this
     */
     ...
     * Sets error
     *
     * @param string $error Error message if no data is available
     *
     * @return $this
     */
