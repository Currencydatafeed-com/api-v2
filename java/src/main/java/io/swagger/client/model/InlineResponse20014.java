...
import io.swagger.client.model.InlineResponse20014Data;
...
public class InlineResponse20014 {
  ...
  @SerializedName("data")
  private List<InlineResponse20014Data> data = null;
  ...
  **/
  ...
  public InlineResponse20014 data(List<InlineResponse20014Data> data) {
    this.data = data;
    return this;
  }
  ...
  public InlineResponse20014 addDataItem(InlineResponse20014Data dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<InlineResponse20014Data>();
    }
  ...
  **/
  @Schema(description = "")
  public List<InlineResponse20014Data> getData() {
    return data;
  }

  public void setData(List<InlineResponse20014Data> data) {
    this.data = data;
  }

  public InlineResponse20014 errorCode(String errorCode) {
