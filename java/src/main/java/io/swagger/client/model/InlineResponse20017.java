...
public class InlineResponse20017 {
  ...
  **/
  ...
  public InlineResponse20017 data(Map<String, List<Object>> data) {
    this.data = data;
    return this;
  }

  public InlineResponse20017 putDataItem(String key, List<Object> dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public InlineResponse20017 errorCode(String errorCode) {
