...
public class InlineResponse20013 {
  ...
  @SerializedName("data")
  private List<InlineResponse20013Data> data = null;
  ...
  **/
  ...
  public InlineResponse20013 data(List<InlineResponse20013Data> data) {
    this.data = data;
    return this;
  }
  ...
  public InlineResponse20013 addDataItem(InlineResponse20013Data dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<InlineResponse20013Data>();
    }
  ...
  **/
  @Schema(description = "")
  public List<InlineResponse20013Data> getData() {
    return data;
  }

  public void setData(List<InlineResponse20013Data> data) {
    this.data = data;
  }

  public InlineResponse20013 errorCode(String errorCode) {
