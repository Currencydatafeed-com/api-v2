...
import io.swagger.client.model.InlineResponse20010Data;
...
public class InlineResponse20010 {
  ...
  @SerializedName("data")
  private List<InlineResponse20010Data> data = null;
  ...
  **/
  ...
  public InlineResponse20010 data(List<InlineResponse20010Data> data) {
    this.data = data;
    return this;
  }
  ...
  public InlineResponse20010 addDataItem(InlineResponse20010Data dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<InlineResponse20010Data>();
    }
  ...
  **/
  @Schema(description = "")
  public List<InlineResponse20010Data> getData() {
    return data;
  }

  public void setData(List<InlineResponse20010Data> data) {
    this.data = data;
  }

  public InlineResponse20010 errorCode(String errorCode) {
