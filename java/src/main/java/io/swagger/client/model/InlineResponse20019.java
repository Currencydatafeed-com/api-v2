...
public class InlineResponse20019 {
  ...
  @SerializedName("data")
  private List<InlineResponse20019Data> data = null;
  ...
  **/
  ...
  public InlineResponse20019 data(List<InlineResponse20019Data> data) {
    this.data = data;
    return this;
  }
  ...
  public InlineResponse20019 addDataItem(InlineResponse20019Data dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<InlineResponse20019Data>();
    }
  ...
  **/
  @Schema(description = "")
  public List<InlineResponse20019Data> getData() {
    return data;
  }

  public void setData(List<InlineResponse20019Data> data) {
    this.data = data;
  }

  public InlineResponse20019 errorCode(String errorCode) {
