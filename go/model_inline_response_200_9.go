...
type InlineResponse2009 struct {
	...
	MacdData []InlineResponse2009MacdData `json:"macd_data,omitempty"`
	RsiData []InlineResponse2009RsiData `json:"rsi_data,omitempty"`
	TechnicalData []InlineResponse2009TechnicalData `json:"technical_data,omitempty"`
	// The symbol queried
	Sembol string `json:"sembol,omitempty"`
