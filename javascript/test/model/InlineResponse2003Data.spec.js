...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2003Data', function() {
      beforeEach(function() {
        instance = new CurrencydatafeedcomApiV2.InlineResponse2003Data();
      });

      it('should create an instance of InlineResponse2003Data', function() {
        // TODO: update the code to test InlineResponse2003Data
        expect(instance).to.be.a(CurrencydatafeedcomApiV2.InlineResponse2003Data);
      });
      ...
      it('should have the property conversionResult (base name: "conversion_result")', function() {
        // TODO: update the code to test the property conversionResult
        expect(instance).to.have.property('conversionResult');
        // expect(instance.conversionResult).to.be(expectedValueLiteral);
      });
