...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse200Symbols', function() {
      beforeEach(function() {
        instance = new CurrencydatafeedcomApiV2.InlineResponse200Symbols();
      });

      it('should create an instance of InlineResponse200Symbols', function() {
        // TODO: update the code to test InlineResponse200Symbols
        expect(instance).to.be.a(CurrencydatafeedcomApiV2.InlineResponse200Symbols);
      });
