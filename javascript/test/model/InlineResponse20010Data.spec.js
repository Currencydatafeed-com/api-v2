...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20010Data', function() {
      beforeEach(function() {
        instance = new CurrencydatafeedcomApiV2.InlineResponse20010Data();
      });

      it('should create an instance of InlineResponse20010Data', function() {
        // TODO: update the code to test InlineResponse20010Data
        expect(instance).to.be.a(CurrencydatafeedcomApiV2.InlineResponse20010Data);
      });
      ...
      it('should have the property lastBtc (base name: "last_btc")', function() {
        // TODO: update the code to test the property lastBtc
        expect(instance).to.have.property('lastBtc');
        // expect(instance.lastBtc).to.be(expectedValueLiteral);
      });
