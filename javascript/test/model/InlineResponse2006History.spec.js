...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2006History', function() {
      beforeEach(function() {
        instance = new CurrencydatafeedcomApiV2.InlineResponse2006History();
      });

      it('should create an instance of InlineResponse2006History', function() {
        // TODO: update the code to test InlineResponse2006History
        expect(instance).to.be.a(CurrencydatafeedcomApiV2.InlineResponse2006History);
      });
